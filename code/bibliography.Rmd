...
The last reference was added on `r format(as.Date(max(bib$date_added_converted), format = "%Y-%m-%d %H:%M:%S %z"), "%d %B, %Y")`.
...
Table \@ref(fig:replay-year) list all publications in the `bibliography.bib` file that mention the term `replay` in the abstract or the title:
