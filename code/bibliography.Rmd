...
Welcome! This website shows the entire bibliography maintained by Lennart Wittkuhn.
...
The lastest reference was added on `r format(as.Date(max(bib$date_added_converted), format = "%Y-%m-%d %H:%M:%S %z"), "%d %B, %Y")`.
...
The matching papers are listed in Figure \@ref(fig:replay-review).
